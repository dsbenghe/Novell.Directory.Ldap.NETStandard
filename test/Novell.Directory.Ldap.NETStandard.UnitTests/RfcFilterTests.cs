...
namespace Novell.Directory.Ldap.NETStandard.UnitTests
{
    public class RfcFilterTests
    {
        ...
        [InlineData(@"(objectSID=\01\05\00\00\00\00\00\05\15\00\00\00\6B\D6\62\04\13\16\10\09\43\17\0A\32\57\04\00\00)")]
        [InlineData("(&(objectCategory=computer)(operatingSystem=*server*))")]
        [InlineData("(&(objectCategory=computer)(operatingSystem=*server*)(!(userAccountControl:1.2.840.113556.1.4.803:=8192)))")]
        [InlineData("(&(objectCategory=person)(objectClass=user)(|(proxyAddresses=*:jsmith@company.com)(mail=jsmith@company.com)))")]
